...
<title>VibedQA Report &mdash; ${escapeHtml(report.url)}</title>
<style>
...
<div class="container">
  ...
  <p class="meta">
    ...
    Scanned: ${new Date(report.scanDate).toLocaleString('en-US')} &nbsp;|&nbsp;
  ...
  <div class="footer">
    <p>Generated by VibedQA v0.1.0 &mdash; AI-powered visual QA</p>
  </div>
</div>
</body>
</html>`;
...
function escapeHtml(str: string): string {
  return str
    ...
    .replace(/>/g, '&gt;')
    .replace(/"/g, '&quot;')
    // Encode non-ASCII characters as HTML numeric entities to prevent encoding issues
